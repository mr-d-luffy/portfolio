...
export default function StatsSection({ scrollYProgress, showOnly }: { scrollYProgress?: any, showOnly?: 'top' | 'bottom' }) {
    ...
    useEffect(() => {
        const galleryImages = [
            { src: '/gallery/photo1.webp', alt: 'photo1' },
            { src: '/gallery/photo2.webp', alt: 'photo2' },
            { src: '/gallery/photo3.webp', alt: 'photo3' },
            { src: '/gallery/photo4.webp', alt: 'photo4' },
            { src: '/gallery/photo5.webp', alt: 'photo5' },
            { src: '/gallery/photo6.webp', alt: 'photo6' },
            { src: '/gallery/photo7.webp', alt: 'photo7' },
            { src: '/gallery/photo8.webp', alt: 'photo8' },
            { src: '/gallery/photo9.webp', alt: 'photo9' },
            { src: '/gallery/photo10.webp', alt: 'photo10' },
            { src: '/gallery/photo11.webp', alt: 'photo11' },
            { src: '/gallery/photo12.webp', alt: 'photo12' },
            { src: '/gallery/photo13.webp', alt: 'photo13' },
            { src: '/gallery/photo14.webp', alt: 'photo14' },
            { src: '/gallery/photo15.webp', alt: 'photo15' },
        ];
