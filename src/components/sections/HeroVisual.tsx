        ...
        <AnimatePresence>
          {showProfile && (
            ...
            >
              <ProfileCard
                name={personal.name}
                title="Full Stack Android Developer & Cyber Security Learner"
                description={`${personal.name} is a dedicated Android Developer & Cyber Security focused on building scalable, intelligent systems and robust software architectures. He specializes in bridging technical innovation with high-performance execution to deliver meaningful and impactful digital solutions.`}
