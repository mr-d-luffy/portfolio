...
const PINNED_REPOS = [
  {
    ...
    forks: 0,
    lang: "TypeScript",
    url: "https://github.com/mr-d-luffy/portfolio"
  },
  {
    name: "libraryManagement",
    desc: "library Management system for the Manage collage or School library offline with sqlite3 database",
    stars: 1,
    forks: 0,
    lang: "Python",
    url: "https://github.com/mr-d-luffy/libraryManagement"
  },
  {
    name: "Urban_Infrastructure_Cascade_Simulator",
    desc: "An interactive web application that models interdependent urban services as a dynamic graph and simulates how a failure in one service (e.g. a power grid outage) cascades into others — then lets you apply recovery actions and measure the impact.",
    stars: 1,
    forks: 0,
    lang: "TypeScript",
    url: "https://github.com/mr-d-luffy/Urban_Infrastructure_Cascade_Simulator"
  },
  // {
  //   name: "POLABDC",
