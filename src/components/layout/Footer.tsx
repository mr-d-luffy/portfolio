...
export function Footer() {
    ...
    useEffect(() => {
        const updateTime = () => {
            ...
            const timeString = new Intl.DateTimeFormat('en-US', { ...options, timeZone: 'Asia/Kolkata' }).format(now);
            // India is UTC+5:30
                                ...
                                <div className="flex-1 flex flex-col justify-center max-w-[1600px] w-full mx-auto relative">
                                    ...
                                    <div className="w-full grid grid-cols-4 gap-x-[5vw] gap-y-[4vh]">
                                        ...
                                        <FooterColumn title={t('localTime')}>
                                            ...
                                            <a
                                                href="https://www.google.com/maps/place/maharathra,+india"
                                                target="_blank"
                                                rel="noopener noreferrer"
